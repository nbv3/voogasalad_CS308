...
/**
 * The class <code>IGameConditionTest</code> contains tests for the class <code>{@link IGameCondition}</code>.
 *
 * @generatedBy CodePro at 11/28/15 12:55 AM
 * @author Henry
 * @version $Revision: 1.0 $
 */
public class IGameConditionTest {
	/**
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(IGameConditionTest.class);
	}
}