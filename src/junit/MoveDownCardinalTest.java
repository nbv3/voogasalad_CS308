...
/**
 * The class <code>MoveDownCardinalTest</code> contains tests for the class <code>{@link MoveDownCardinal}</code>.
 *
 * @generatedBy CodePro at 11/28/15 12:55 AM
 * @author Henry
 * @version $Revision: 1.0 $
 */
public class MoveDownCardinalTest {
	/**
	...
	public void testSetMovement_1()
		throws Exception {
		MoveDownCardinal fixture = new MoveDownCardinal();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(MoveDownCardinalTest.class);
	}
}