...
import com.syntacticsugar.vooga.authoring.editor.ToolbarOptions;
...
/**
 * The class <code>ToolbarOptionsTest</code> contains tests for the class <code>{@link ToolbarOptions}</code>.
 *
...
public class ToolbarOptionsTest {
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(ToolbarOptionsTest.class);
	}
}