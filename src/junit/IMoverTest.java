...
/**
 * The class <code>IMoverTest</code> contains tests for the class <code>{@link IMover}</code>.
 *
 * @generatedBy CodePro at 11/28/15 12:56 AM
 * @author Henry
 * @version $Revision: 1.0 $
 */
public class IMoverTest {
	/**
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(IMoverTest.class);
	}
}