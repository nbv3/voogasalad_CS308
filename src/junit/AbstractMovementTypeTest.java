...
/**
 * The class <code>AbstractMovementTypeTest</code> contains tests for the class <code>{@link AbstractMovementType}</code>.
 *
 * @generatedBy CodePro at 11/28/15 12:55 AM
 * @author Henry
 * @version $Revision: 1.0 $
 */
public class AbstractMovementTypeTest {
	/**
	...
	public void testExecuteAction_1()
		throws Exception {
		AbstractMovementType fixture = new MoveDownCardinal();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(AbstractMovementTypeTest.class);
	}
}