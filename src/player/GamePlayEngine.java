...
public class GamePlayEngine {
	...
	public void update(IGameUniverse toUpdate) {
		checkCollisions(toUpdate);
		updateState(toUpdate);
		processSpawner(toUpdate);
		processGraveyard(toUpdate);
		processSpawnyard(toUpdate);
		processScore(toUpdate);
	}
	...
	private void processScore(IGameUniverse toUpdate) {
		IScore score = toUpdate.getScore();
		score.update();
	}
