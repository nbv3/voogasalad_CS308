...
public class GameChooser implements IVoogaApp, IDirectoryViewer<String> {
	...
	public GameChooser() {
		...
		showDirectoryContents(myDirectory, e -> getGameDescriptions(myDirectory), null);
	...
	@Override
	public void showDirectoryContents(File directory, IFileConverter<String> fileConverter, INodeCreator<String> nodeCreator) {
		myGameNames.clear();
